...
public class menuBar : MonoBehaviour   {
    ...
    private ItemInfo[] menuCustomize = new ItemInfo[5] {new ItemInfo("Back","icon_place","principal","",false),
                                                        ...
                                                        new ItemInfo("Defense","icon_place","subCustomize","defense",false) 
                                                        };
    ...
    /*------------------------------------------------------------------------------------------------------------------------------------------- */
    private ItemInfo[] subMenuArmesM = new ItemInfo[5] {new ItemInfo("Back","icon_place","customize","",false),
                                                        ...
                                                        new ItemInfo("Kinetic Flipper","icon_place","placerItem","weaponFlipper",true),
                                                        new ItemInfo("Circular Saw","icon_place","placerItem","weaponSaw",true)
                                                        };
    /*------------------------------------------------------------------------------------------------------------------------------------------- */
    private ItemInfo[] subMenuBases = new ItemInfo[3] { new ItemInfo("Back","icon_place","customize","",false),
    ...
    /*------------------------------------------------------------------------------------------------------------------------------------------- */    
    private ItemInfo[] subMenuDefense = new ItemInfo[2]{new ItemInfo("Back","icon_place","customize","",false),
